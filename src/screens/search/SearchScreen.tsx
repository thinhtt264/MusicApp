        ...
        {searchData.keyword ? (
            ...
            {selectedFilter === 'track' ? (
              <LoadMoreList
                ...
                style={[
                  styles.item,
                  {
                    marginBottom: currentTrack.id ? MINIPLAYER_HEIGHT + 30 : 30,
                  },
                ]}
              ...
              <LoadMoreList
                ...
                style={[
                  styles.item,
                  {
                    marginBottom: currentTrack.id ? MINIPLAYER_HEIGHT : 30,
                  },
                ]}
          ...
          <>
            ...
            <AnimatedList
              ...
              ItemSeparatorComponent={() => <Divider height={15} />}
              renderFooter={() => {
                return <View style={{ marginBottom: MINIPLAYER_HEIGHT }} />;
              }}
              renderItem={({ item }: any) =>
                renderItem({
                  item: item,
